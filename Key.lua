...
local Config = {
    ...
    ServiceId       = 26989, -- Your PlatoBoost Service ID
    PlatoSecret     = "974e027a-e417-40fa-9a48-2e210e08cd5b", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "261231", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/MidasHUB-rscripts/sharkbitekeysystem/refs/heads/main/sharkbite.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "MidasHUB", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "MidasHUB", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "MidasHUB", -- The main title shown at the top of the GUI
